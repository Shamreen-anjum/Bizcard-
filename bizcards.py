...
mydb = mysql.connector.connect(
    user='root',
    host='localhost',
    password='Anjum@2024', auth_plugin='mysql_native_password')
...
icon = Image.open("C:/Users/mirza/OneDrive/Pictures/card1.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """OCR"""})
...
if selected == "Home":
    ...
    with col1:
        st.image(Image.open("C:/Users/mirza/OneDrive/Pictures/card1.png"), width=500)
